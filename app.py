...
# Load custom face models
MTCNN_PATH = 'mtcnn.pth'
RESNET_PATH = 'resnet.pth'
mtcnn = torch.load(MTCNN_PATH, map_location='cpu', weights_only=False)
resnet = torch.load(RESNET_PATH, map_location='cpu', weights_only=False).eval()
